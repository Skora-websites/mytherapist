...
export default function Hero() {
  return (
    <section className="relative min-h-[65vh] flex items-center overflow-hidden mt-4 sm:mt-0">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-8 sm:pt-2 sm:pb-10 lg:pt-4 lg:pb-16 w-full">
        <div className="max-w-2xl z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.08] mb-2 tracking-tight whitespace-normal sm:whitespace-nowrap"><span className="text-brand-pink">Child Development Centre</span></h1>
